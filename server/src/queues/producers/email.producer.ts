import { QUEUES, EmailVerificationPayload, PasswordResetPayload, WelcomePayload } from "../../constant/queue.constant";
...
export const producePasswordResetEmail = async (
  ...
  await createProducer<PasswordResetPayload>(
...
export const produceWelcomeEmail = async (
  ...
  await createProducer<WelcomePayload>(
